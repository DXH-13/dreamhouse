...
var grokOgIdentity = { "site": {
	"title": "Nhà Phố 5×30",
	"card": "custom",
	"description": "A modern Vietnamese townhouse — cubic mass, teak fins, warm plaster.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_PRUPcd = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_PRUPcd
	};
	return ((_m, p) => {
		return {
			data,
